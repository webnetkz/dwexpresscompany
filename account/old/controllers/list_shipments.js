app.controller('listShipments', function($scope, $http, $locale, $cookies, $location, $timeout, $interval, $filter){

   console.log("CONTROLLER: listShipments");
   ...
   $scope.actions.delete = function(shipment){
      $scope.actions.delete.isVisible = true;
      $scope.actions.id = shipment.id;
