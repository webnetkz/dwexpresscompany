	...
	<body>
		...
		<div class="w100 siteTop" id='siteTop'>
			<div class="container">
				...
				<div class="phones">
					<a href='tel:+79161352444' class='phone'>+7 (916) 135-24-44</a>
					<div class="social">
						<?=$language['write_in']; ?>: <a target="_blank" href='https://api.whatsapp.com/send?phone=<?=$phone1wp; ?>'><img src='img/wp.png' alt='WhatsApp'></a><a href='viber://add?number=<?=$phone1wp; ?>' target="_blank"><img src='img/viber.png' alt='Viber'></a><a target="_blank" href='weixin://dl/chat?wxid_iwgsbm229z6p12'><img src='img/wechat.png' alt='WeChat'></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="fake">
			<div class="w100" id='head'>
				<a class="pull"><img src="img/menu.jpg" alt="Меню..."></a>
				...
				<div class="flex">
					<div class="left">
						<div class="text">
							...
							<img class='fb' src='img/logistics.gif' alt=''>
						</div>
					</div>
					<div class="right">
						<div class="text">
						...
						<div class="btns">
							<a href="client-window.php<?php if ($lang == "zn_CN") { echo '?lang=zn_CN'; } ?>"  class="btn" target="_blank"><?=$language['main-btn1']; ?></a>
			...
			<div class="container">
				<div class="left">
					...
					<div class="fl">
						<div class="item">
							<div class="l">
								<div class="icons"><img class='viber' src='img/viber-mini.png' alt=''><img class='chat' src='img/chat-mini.png' alt=''><img src='img/wp-mini.png' alt=''></div>
								<div class="text">
									<?=$language['wp']; ?>
								</div>
							</div>
							<div class="r"><a href='tel:+79161352444'>+7 (916) 135-24-44</a></div>
						</div>
						<div class="item">
							<div class="l">
						...
						<div class="item">
							<div class="l">
								<div class="icons"><img src='img/skype.png' alt=''></div>
								<div class="text">
									<?=$language['skype']; ?>
								</div>
							</div>
							<div class="r"><a href='callto:DWExpress DWE'>DWExpress DWE</a></div>
						</div>
						<div class="item">
							<div class="l">
							...
							<div class="r"><a href='http://ems.dealwd.com/'>ems.dealwd.com</a></div>
						</div>
					</div>
					<div class="trck">
						"快递查询"，链接是：<a href="http://m.kuaidi100.com" target="_blank">http://m.kuaidi100.com</a>
					</div>
					<div class="social">
						<?=$language['write_in']; ?>: <a target="_blank" href='https://api.whatsapp.com/send?phone=<?=$phone1wp; ?>'><img src='img/wp.png' alt='WhatsApp'></a><a href='viber://add?number=<?=$phone1wp; ?>' target="_blank"><img src='img/viber.png' alt='Viber'></a><a target="_blank" href='weixin://dl/chat?wxid_iwgsbm229z6p12'><img src='img/wechat.png' alt='WeChat'></a>
					</div>
					<a class='dev' href='http://one-page.kz' title="Разработка и поддержка landing page в Казахстане" target="_blank">
						<?=$language['dev']; ?>
					</a>
				</div>
				<div class="right">
		...
		<div class="modal" id="modal">
			...
			<form action="" method="post">
				...
				<input type="hidden" name="info" value="Вопрос под калькулятором">
		...
		<div class="modal" id="modal_question">
			...
			<form action="" method="post">
				...
				<input type="mail" name="email" class="email" value="<?=$language['form_mail']; ?>"><br>
				<textarea name='quest-text' class='quest-text' value='<?=$language[' form_text ']; ?>'></textarea><br>
				<input type="hidden" name="info" value="<?=$language['lang']; ?> Заявка на расчет стоимости доставки">
				<button class="form-mail"><?=$language['form_btn']; ?></button>
				<div class="loading">
					<img src="css/fancybox_loading.gif" alt="Загрузка">
				</div>
